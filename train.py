...
parser.add_argument('--lr_decay_steps', default='80,120,160,180', help='When to decay the learning rate (in epochs) [default: 80,120,160]')
parser.add_argument('--lr_decay_rates', default='0.1,0.1,0.1,0.1', help='Decay rates for lr decay [default: 0.1,0.1,0.1]')
